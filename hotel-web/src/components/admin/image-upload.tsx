    ...
    <div className="space-y-6">
          ...
          <CardContent className="p-8 text-center">
            ...
            >
              ...
              <p className="text-sm text-gray-600 mb-4">
                Rasmlarni bu yerga tortib tashlang yoki yuklash uchun bosing
              </p>
              <Button
                type="button"
                variant="outline"
              ...
              <p className="text-xs text-gray-500 mt-3">
                PNG, JPG, JPEG formatlarini qo&rsquo;llab-quvvatlaydi • Maksimal
                10MB
              </p>
            </div>
          </CardContent>
      ...
      {selectedFiles.length === 0 && existingImages.length === 0 && (
        <div className="text-center py-8 bg-gray-50 rounded-lg border-2 border-dashed border-gray-200">
          ...
          <p className="text-xs text-gray-400">
            Yuqoridagi tugma orqali rasmlar qo&rsquo;shing
          </p>
        </div>
      )}
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
        ...
        <ul className="text-xs text-blue-700 space-y-1">
          <li>
            • Eng yaxshi sifat uchun 1200x800 piksel yoki undan yuqori
            o&rsquo;lchamdagi rasmlar ishlating
          </li>
          <li>• Birinchi rasm asosiy rasm sifatida ko&rsquo;rsatiladi</li>
          <li>• Bir vaqtda bir nechta rasmlarni yuklashingiz mumkin</li>
          <li>• Qo&rsquo;llab-quvvatlanadigan formatlar: JPG, PNG, JPEG</li>
        </ul>
      </div>
    </div>
  );
