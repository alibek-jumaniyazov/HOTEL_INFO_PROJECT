...
export default function HotelInfoForm() {
    ...
    return (
      <Card>
        <CardContent className="p-8 text-center">
          ...
          <p>Hotel ma'lumotlari yuklanmoqda...</p>
        </CardContent>
      </Card>
    )
  }
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>Hotel Asosiy Ma'lumotlari</CardTitle>
      </CardHeader>
      <CardContent>
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">Hotel Nomi *</label>
              <Input
          ...
          <div>
            ...
            <Textarea
              ...
              rows={3}
            />
            <p className="text-xs text-gray-500 mt-1">Masalan: Bepul WiFi, Parking, Restaurant, Fitnes zal</p>
          </div>

          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">Hotel Rasmi</label>
