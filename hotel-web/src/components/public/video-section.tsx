...
//       <div className="container mx-auto px-4 relative z-10">
//         <div className="text-center mb-12">
//           <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">Bizning hotelni ko'ring</h2>
//           <p className="text-lg text-blue-100 max-w-2xl mx-auto">
//             Virtual sayohat orqali bizning hotel va xizmatlarimiz bilan tanishing. Har bir burchakda sizni ajoyib
//             tajriba kutmoqda.
//           </p>
//         </div>
...
//             <div className="relative overflow-hidden rounded-2xl shadow-2xl">
//               <SimpleImage
//                 src="/images/hotel-video-thumbnail.jpg"
//                 alt="Hotel Video"
...
//               <div className="text-blue-200">Ultra HD sifat</div>
//             </div>
//             <div className="text-center">
//               <div className="text-3xl font-bold text-white mb-2">360°</div>
//               <div className="text-blue-200">Virtual tur</div>
//             </div>
//             <div className="text-center">
//               <div className="text-3xl font-bold text-white mb-2">5 min</div>
//               <div className="text-blue-200">To'liq ko'rsatuv</div>
//             </div>
//           </div>
//         </div>
//       </div>
